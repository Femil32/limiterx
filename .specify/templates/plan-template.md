...
- [ ] **User experience consistency**: Config, errors, and docs plan stay aligned across adapters; breaking API changes are versioned and migration is noted.
- [ ] **Performance**: Hot-path impact identified; budgets or benchmarks stated for changes affecting latency, memory, or storage churn.
